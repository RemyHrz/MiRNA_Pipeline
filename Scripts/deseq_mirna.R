...
for (grp in comparison_groups) {
  ...
  # Volcano plot
  plotname<-paste0("miRNA_Volcano_", grp, "_vs_Mock_adjpval",pvalstr,"_FC", thresholdFC,".png")
  ...
  output_file <- paste0("miRNA_DESeq2_", grp, "_vs_Mock_adjpval",pvalstr,"_FC", thresholdFC, ".csv")
